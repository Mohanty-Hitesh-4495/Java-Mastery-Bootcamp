...
/*
    Imagine you have an abstract class called "OOPs.Bank" that offers functionality to
    determine the rate of interest through the method interestRate(). Now,
    generate subclasses named OOPs.SBI, OOPs.ICICI, and AXIS banks. These subclasses
...
class SBI extends Bank{
    @Override // rate of interest of OOPs.SBI bank = 8
...
class ICICI extends Bank{
    @Override // rate of interest of OOPs.ICICI bank = 7.5
    public float getInterest(){
        interest=7.5f;
        return (pa*time*interest)/100;
    }
...
class Axis extends Bank{
    @Override // rate of interest of OOPs.Axis bank = 9
    public float getInterest(){
        interest=9;
        return (pa*time*interest)/100;
    }
...
public class DemoBank{
    public static void main(String[] args) {
        ...
        System.out.println("OOPs.SBI INTEREST AMOUNT : "+ob1.getInterest());
        System.out.println("AXIS INTEREST AMOUNT : "+ob2.getInterest());
        System.out.println("OOPs.ICICI INTEREST AMOUNT : "+ob3.getInterest());
